...
Object.entries(pages).forEach(([route, meta]) => {
  ...
  // Add/replace Open Graph meta tags before the comment
  const ogTags = `
  ...
  // Insert OG tags before the comment line
  html = html.replace(
    /<!-- Open Graph and Twitter tags are dynamically generated by react-helmet-async for each page -->/,
    ogTags + '<!-- Open Graph and Twitter tags are dynamically generated by react-helmet-async for each page -->'
  );
