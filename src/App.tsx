          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a 
                ...
                className="bg-destructive text-destructive-foreground px-4 py-2 font-bold hover:opacity-90 transition-opacity inline-block"
              >
                Contact
              </a>
            </div>
      ...
      <section id="home" className="min-h-screen flex flex-col justify-center items-center relative bg-gradient-to-br from-primary/10 to-accent/10 px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex justify-center space-x-6 mb-8">
            <a href="https://www.linkedin.com/in/brentjsummers/" target="_blank" rel="noopener noreferrer" 
               className="p-3 bg-background border-2 border-foreground hover:bg-accent hover:text-accent-foreground transform hover:scale-110 transition-all duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
            </a>
            <a href="https://x.com/brentsummers" target="_blank" rel="noopener noreferrer"
               className="p-3 bg-background border-2 border-foreground hover:bg-accent hover:text-accent-foreground transform hover:scale-110 transition-all duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
              </svg>
            </a>
            <a href="https://github.com/therealbrent" target="_blank" rel="noopener noreferrer"
               className="p-3 bg-background border-2 border-foreground hover:bg-accent hover:text-accent-foreground transform hover:scale-110 transition-all duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="mailto:brent.j.summers@gmail.com"
               className="p-3 bg-background border-2 border-foreground hover:bg-accent hover:text-accent-foreground transform hover:scale-110 transition-all duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              I am responsible for AI Platforms and GTM Innovation at Qualcomm Technologies. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="border-4 border-foreground transform hover:scale-105 transition-transform duration-300 bg-card p-6">
              ...
              <p className="text-muted-foreground mb-4">
                Two decades of experience at the intersections of marketing, technology, and UX.
              </p>
              <button 
            ...
            <div className="border-4 border-foreground transform hover:scale-105 transition-transform duration-300 bg-card p-6">
              ...
              <p className="text-muted-foreground mb-4">
                Insights and musings on AI, marketing strategy, and emerging technologies.
              </p>
              <button 
            ...
            <div className="border-4 border-foreground bg-card p-8 mb-12">
              ...
              <div className="space-y-4 text-lg">
                ...
                <p>
                  ...
                  🔹 Established commercial channel marketing
                  🔹 Generative AI rapidly adopted across every marketing function
                </p>
                <p>
            ...
            <div className="border-4 border-foreground bg-card p-8">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <span 
                    key={skill}
                    className="bg-secondary text-secondary-foreground text-sm font-semibold px-3 py-2 border-2 border-foreground"
                  >
                    {skill}
                  </span>
                ))}
      ...
      <footer className="bg-foreground text-background py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <button 
            ...
            className="bg-primary text-primary-foreground text-lg font-bold px-8 py-4 hover:opacity-90 transition-opacity"
          >
            Get In Touch
          </button>
