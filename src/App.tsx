      ...
      <section id="home" className="min-h-screen flex flex-col justify-center items-center relative bg-gradient-to-br from-primary/10 to-accent/10 px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <a href="mailto:brent.j.summers@gmail.com" className="border-2 border-foreground bg-transparent text-foreground text-lg font-bold px-8 py-4 transform hover:scale-105 transition-transform hover:bg-accent hover:text-accent-foreground inline-block">
              Let's Connect
            </a>
          </div>
          ...
          <div className="flex justify-center space-x-6 mb-8">
            ...
            <a href="mailto:brent.j.summers@gmail.com" className="p-3 bg-background border-2 border-foreground hover:bg-accent hover:text-accent-foreground transform hover:scale-110 transition-all duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
🔹 Generative AI rapidly adopted across every marketing function</p>
            ...
            <div className="border-4 border-foreground bg-card p-8">
              ...
              <div className="flex flex-wrap gap-3">
                {["Account-Based Marketing", "Content Strategy", "Digital Marketing", "UX Strategy", "AI Platforms", "People Management", "Project Management", "Program Management"].map(skill => <span key={skill} className="bg-secondary text-secondary-foreground text-sm font-semibold px-3 py-2 border-2 border-foreground">
                    {skill}
                  </span>)}
              </div>
            </div>
