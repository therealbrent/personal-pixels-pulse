  ...
  return (
    <div className="min-h-screen bg-background text-foreground page-transition">
      <SEO
        ...
        ogTitle="Meet Brent Summers: AI-Powered Marketing Leader, Leveraging Generative AI since June 2020."
      ...
      <header
        id="home"
        className="h-screen flex flex-col justify-center items-center relative bg-gradient-to-br from-accent/20 via-primary/15 to-secondary/5 px-4 overflow-hidden"
      >
        {/* Decorative geometric elements */}
        <div
          className="absolute top-20 left-10 w-24 h-24 border-8 border-accent/30 rotate-12 hidden lg:block"
          aria-hidden="true"
        ></div>
        <div
          className="absolute bottom-32 right-16 w-32 h-32 bg-cobalt/20 -rotate-6 hidden lg:block"
          aria-hidden="true"
        ></div>
        <div
          className="absolute top-1/3 right-1/4 w-16 h-16 border-8 border-oxblood/40 rotate-45 hidden md:block"
          aria-hidden="true"
        ></div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 md:gap-12">
            ...
            <div className="flex items-center gap-6 sm:gap-10 md:gap-16">
              <span className="text-2xl sm:text-3xl md:text-4xl font-black text-background tracking-tight hover:text-accent transition-colors">
                Forbes
              </span>
      ...
      <main id="main-content">
        ...
        <div className="relative overflow-hidden" role="presentation" aria-hidden="true">
          <div className="h-20 bg-gradient-to-br from-accent via-secondary to-primary relative">
            ...
            <div
              className="absolute -top-3 left-8 w-12 h-16 bg-accent border-2 border-foreground transform -skew-y-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "-2px", ["--p-rot" as any]: "3deg" }}
            ></div>
            <div
              className="absolute top-2 left-24 w-8 h-8 bg-primary border-2 border-foreground transform rotate-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "3px", ["--p-y" as any]: "2px", ["--p-rot" as any]: "4deg" }}
            ></div>
            <div
              className="absolute -bottom-2 left-40 w-16 h-6 bg-secondary border-2 border-foreground transform skew-x-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "-2px", ["--p-y" as any]: "2px", ["--p-rot" as any]: "-3deg" }}
            ></div>
            <div
              className="absolute top-1 right-32 w-6 h-24 bg-secondary border-2 border-foreground transform rotate-30 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "-3px", ["--p-y" as any]: "-1px", ["--p-rot" as any]: "3deg" }}
            ></div>
            <div
              className="absolute -bottom-4 right-16 w-10 h-10 bg-accent border-2 border-foreground transform -rotate-30 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "3px", ["--p-y" as any]: "-2px", ["--p-rot" as any]: "-4deg" }}
            ></div>
            <div
              className="absolute -top-2 right-4 w-14 h-14 bg-primary border-4 border-foreground transform rotate-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "4px", ["--p-y" as any]: "-3px", ["--p-rot" as any]: "5deg" }}
            ></div>
            <div
              className="absolute top-6 left-64 w-4 h-12 bg-secondary border-2 border-foreground transform -skew-x-30 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "1px", ["--p-y" as any]: "-1px", ["--p-rot" as any]: "2deg" }}
            ></div>
          </div>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="border-4 border-foreground bg-card p-8 mb-12">
                ...
                <div className="flex flex-wrap gap-3">
                  {["Strategic Marketing Leadership", "Human-Centered Design", "AI & Technology Strategy"].map(
                    (skill, index) => (
                      <span
                        key={index}
              ...
              <div className="border-4 border-foreground bg-card p-8">
                ...
                <div className="space-y-6 text-lg">
                  ...
                  <div>
                    <h4 className="text-xl font-bold mb-3 text-primary-text">
                      How a fan-first mindset shaped my career
                    </h4>
                    <p>
                  ...
                  {showFullStory && (
                    <>
                      <div>
                        <h4 className="text-xl font-bold mb-3 text-primary-text">
                          The proving ground that sharpened my leadership
                        </h4>
                        <p className="mb-4">
                          Next, I moved agency-side where I learned to pitch big ideas, lead large quality-obsessed
                          teams, and expand into new markets.
                        </p>
                        <ul className="space-y-3 list-disc list-inside text-base">
                          <li>
                            <strong>At Digitaria,</strong> I was the Executive Producer on the Qualcomm account where I
                            had 5 direct reports plus a dynamic project team that sometimes scaled to 40 contributing
                            resources. My team delivered several high-stakes projects that made Qualcomm an early
                            adopter of cloud-computing and responsive design.
                          </li>
                          <li>
                            <strong>At Digital Telepathy,</strong> I pivoted away from providing client services to
                            marketing leadership. Our GTM strategy included the incubation — and eventual sale — of
                            digital products (Slide Deck, Hello Bar, and Filament), and inbound marketing driven
                            primarily by our blog which was recognized by{" "}
                            <ExternalLink
                              href="https://designers.hubspot.com/blog/11-of-the-most-influential-ux-blogs-you-need-to-follow"
                              variant="primary"
                              className="inline"
                            >
                              HubSpot
                            </ExternalLink>{" "}
                            for its influence on the industry.
                          </li>
                          <li>
                            <strong>At Blink,</strong> I opened and scaled a studio in San Diego — winning our first few
                            clients and growing the team from 3 employees to 12. After stabilizing the new office, I
                            overhauled our Engineering practice to reach profitability and led a rebrand project
                            following the acquisition of Tectonic. Our account-based GTM strategy leveraged our
                            beautiful studio to build relationships with local leaders from HP, Qualcomm, ServiceNow,
                            and more by{" "}
                            <ExternalLink
                              href="https://www.youtube.com/watch?v=UEKVb_ZNGk8&list=PL9g8_WUUTpAnAAybzhb8Tx0gD5ZfoiFaI"
                              variant="primary"
                              className="inline"
                            >
                              hosting meetups
                            </ExternalLink>
                            , workshops, and the occasional party.
                          </li>
                          <li>
                            <strong>At Metalab,</strong> I led the in-house team of three responsible for marketing
                            strategy and sales enablement. In collaboration with freelancers another agency, we designed
                            and executed a content strategy that delivered 3 marquee case studies and 20+ sales
                            enablement decks — ultimately leading to $3.8M in influenced revenue, a 5.5x ROI.
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        <h4 className="text-xl font-bold mb-3 text-primary-text">
                          The opportunity to drive outsized impact in an enterprise
                        </h4>
                        <p className="mb-4">
                          I joined Qualcomm Technologies to build an ABM program. In pursuit of that goal, I became an
                          early champion for Generative AI. Now, I am the Global Lead for AI Platforms & GTM Innovation.
                          Some of my key achievements include:
                        </p>
                        <ul className="space-y-2 list-disc list-inside text-base">
                          <li>
                            Established and scaled an award-winning ABM program that influences billions in annual
                            pipeline across several business units.
                          </li>
                          <li>
                            Built and successfully transitioned commercial channel marketing to dedicated teams,
                            onboarding more than a dozen partners worldwide.
                          </li>
                          <li>
                            Pioneered enterprise-wide Generative AI adoption across marketing functions, achieving 8.6x
                            ROI based purely on time savings.
                          </li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mb-4">
                          My leadership approach bridges the gap between visionary strategy and tactical execution.
                        </p>
                        <ul className="space-y-2 list-disc list-inside text-base mb-4">
                          <li>
                            <strong>I start with empathy.</strong> Understanding users, customers, and teammates is fuel
                            for innovation.
                          </li>
                          <li>
                            <strong>I make transformation tangible.</strong> Big bets only matter when they land in the
                            real world.
                          </li>
                          <li>
                            <strong>I let data guide me.</strong> Gut instincts spark ideas, but evidence earns
                            decisions (and investment).
                          </li>
                          <li>
                            <strong>I break silos.</strong> Collaboration isn't optional; it's a force-multiplier.
                          </li>
                          <li>
                            <strong>I play the long game.</strong> Balancing today's wins with tomorrow's advantage.
                          </li>
                        </ul>
                      </div>
        ...
        <div className="relative overflow-hidden">
          <div className="h-20 bg-gradient-to-l from-destructive via-primary to-accent relative">
            ...
            <div
              className="absolute -top-4 left-16 w-20 h-8 bg-secondary border-3 border-foreground transform -skew-x-12 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "-1px", ["--p-rot" as any]: "3deg" }}
            ></div>
            <div
              className="absolute top-3 right-24 w-12 h-12 bg-primary border-4 border-foreground transform rotate-12 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "3px", ["--p-y" as any]: "-2px", ["--p-rot" as any]: "4deg" }}
            ></div>
            <div
              className="absolute -bottom-3 right-8 w-16 h-16 bg-destructive border-3 border-foreground transform -rotate-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "4px", ["--p-y" as any]: "3px", ["--p-rot" as any]: "-5deg" }}
            ></div>
            <div
              className="absolute top-1 left-48 w-6 h-18 bg-accent border-2 border-foreground transform skew-y-12 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "1px", ["--p-y" as any]: "-2px", ["--p-rot" as any]: "2deg" }}
            ></div>
            <div
              className="absolute -top-1 left-72 w-18 h-4 bg-secondary border-2 border-foreground transform rotate-60 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "-1px", ["--p-rot" as any]: "3deg" }}
            ></div>
            <div
              className="absolute bottom-2 left-96 w-8 h-10 bg-primary border-2 border-foreground transform -skew-y-30 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "1px", ["--p-rot" as any]: "-3deg" }}
            ></div>
            <div
              className="absolute -bottom-2 right-40 w-5 h-14 bg-accent border-2 border-foreground transform rotate-75 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "1px", ["--p-y" as any]: "2px", ["--p-rot" as any]: "2deg" }}
            ></div>
          </div>
        </div>
        ...
        <section id="writing" className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                I believe that{" "}
                <Link to="/speaking" className="text-primary-text hover:text-accent underline font-semibold">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <article
                ...
                onClick={() =>
                  window.open(
                    "https://www.cionews.com/post/qualcomm-enterprise-ai-strategy-oversight-brent-summers",
                    "_blank",
                  )
                }
              >
                <span className="inline-flex bg-primary text-primary-foreground px-3 py-1 text-sm font-semibold mb-4">
                  AI Strategy
                </span>
                <h3 className="text-xl font-bold mb-3">
                  Why Qualcomm's Playbook For AI Starts With Intention—And Ends With A Human
                </h3>
                <p className="text-muted-foreground mb-4">
                  From brand voice guardrails to security-first agent design, my approach offers a blueprint for
                  automating AI tasks with intention in marketing organizations.
                </p>
              ...
              <article
                ...
                onClick={() =>
                  window.open(
                    "https://contentstrategy.substack.com/p/my-favorite-content-strategy-frameworks",
                    "_blank",
                  )
                }
              >
                <span className="inline-flex bg-accent text-accent-foreground px-3 py-1 text-sm font-semibold mb-4">
                  Content Strategy
                </span>
              ...
              <article
                className="border-4 border-foreground bg-card p-6 transform hover:scale-105 transition-transform duration-300 cursor-pointer"
                onClick={() =>
                  window.open("https://blinkux.com/ideas/evidence-driven-design-supports-innovation", "_blank")
                }
              >
                <span className="inline-flex bg-secondary text-secondary-foreground px-3 py-1 text-sm font-semibold mb-4">
                  Innovation
                </span>
                <h3 className="text-xl font-bold mb-3">How Evidence-driven Design Supports Innovation</h3>
                <p className="text-muted-foreground mb-4">
                  I led marketing at Blink UX for three years. This is a story that explains the design philosophy used
                  to create product for NASA, Amazon, Microsoft , and other notable clients.
                </p>
                <span className="text-primary-text font-semibold">Read more →</span>
              </article>
            </div>
            ...
            <div className="mt-16 max-w-4xl mx-auto">
              {/* Performance-optimized slot machine */}
              <SlotMachine />
            </div>
          </div>
        </section>
        ...
        <div className="relative overflow-hidden">
          <div className="h-20 bg-gradient-to-r from-primary via-accent to-secondary relative">
            ...
            <div
              className="absolute -top-6 left-12 w-16 h-16 bg-destructive border-4 border-foreground transform rotate-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "4px", ["--p-y" as any]: "-2px", ["--p-rot" as any]: "5deg" }}
            ></div>
            <div
              className="absolute top-4 right-20 w-10 h-12 bg-accent border-3 border-foreground transform -skew-x-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "1px", ["--p-rot" as any]: "-3deg" }}
            ></div>
            <div
              className="absolute -bottom-4 right-40 w-8 h-8 bg-primary border-2 border-foreground transform rotate-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "-2px", ["--p-rot" as any]: "3deg" }}
            ></div>
            <div
              className="absolute top-1 left-32 w-22 h-6 bg-secondary border-2 border-foreground transform -skew-x-12 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "1px", ["--p-y" as any]: "1px", ["--p-rot" as any]: "-2deg" }}
            ></div>
            <div
              className="absolute -top-2 left-64 w-6 h-18 bg-destructive border-2 border-foreground transform rotate-30 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "-1px", ["--p-rot" as any]: "3deg" }}
            ></div>
            <div
              className="absolute bottom-1 right-8 w-12 h-4 bg-accent border-2 border-foreground transform skew-y-45 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "2px", ["--p-y" as any]: "1px", ["--p-rot" as any]: "3deg" }}
            ></div>
            <div
              className="absolute -bottom-3 left-80 w-14 h-10 bg-primary border-3 border-foreground transform -rotate-60 transform-gpu will-change-[transform] transition-transform duration-300 ease-out hover:animate-parallax-hover motion-reduce:hover:animate-none motion-reduce:transition-none"
              style={{ ["--p-x" as any]: "-3px", ["--p-y" as any]: "2px", ["--p-rot" as any]: "-4deg" }}
            ></div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                ...
                <a href="/design-case-studies" className="text-primary-text hover:text-accent underline">
                  design case studies
                </a>
                .
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div className="border-4 border-foreground bg-card p-6">
                  <blockquote className="text-lg italic text-muted-foreground mb-6">
                    "Brent brings a great mix of strategy and execution to our company's account. Like most fast-moving
                    start-ups, we juggle needing great content along with 'big picture' thinking. Brent consistently
                    manages the day-to-day while continuing to bring new, fresh ideas to our marketing strategy."
                  </blockquote>
                ...
                <div className="border-4 border-foreground bg-card p-6">
                  <blockquote className="text-lg italic text-muted-foreground mb-6">
                    "Brent Summers is one of the smartest people I have ever had the pleasure to collaborate with. His
                    attention to detail and care for the end user comes through in everything he does. Brent and his
                    team helped us create a beautiful Web experience that eclipsed the previous site in every facet.
                    From design to conversion, it was a revelation."
                  </blockquote>
                  <div className="text-right">
                ...
                <div className="border-4 border-foreground bg-card p-6">
                  <blockquote className="text-lg italic text-muted-foreground mb-6">
                    "Brent is hands down the best manager I've had. He takes the time to understand you as a person so
                    he can advocate for your growth in a way that aligns with company goals. He shares his expertise
                    while being open to new ways of doing things. He's detail and process-orientated but leaves room for
                    creativity. He's an excellent mentor, collaborator, and leader. My confidence as a marketer has
                    grown 10x since he stepped in to lead the team."
                  </blockquote>
                  <div className="text-right">
                ...
                <div className="border-4 border-foreground bg-card p-6">
                  <blockquote className="text-lg italic text-muted-foreground mb-6">
                    "I had the immense good fortune to report to Brent on the marketing team at Blink UX. Though we have
                    both moved on to other organizations, I am lucky to continue to call on him for counsel and
                    mentorship. Brent is strategic, ambitious, and smart. He brings a degree of rigor and grit to his
                    work that I am constantly trying to emulate. In addition to the high quality of the work he produces
                    directly, he is a champion of true collaboration and professional growth. When I reported to Brent,
                    I felt empowered to do my most bold and creative work, confident that he had my back in ways big and
                    small. Any team would be lucky to have him."
                  </blockquote>
                  <div className="text-right">
      ...
      <div className="min-h-screen flex flex-col w-full bg-background">
        ...
        <main id="main-content" className="flex-1">
          <Routes>
            ...
            <Route path="/archive" element={<SpeakingMediaPage />} />
            <Route path="/insights" element={<Navigate to="/archive" replace />} />
            <Route path="/speaking" element={<Navigate to="/archive" replace />} />
            <Route path="/speaking-media" element={<Navigate to="/archive" replace />} />
