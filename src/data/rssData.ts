...
// Lazy-loaded RSS content to improve initial bundle size
export const loadRSSContent = async (): Promise<RSSItem[]> => {
  // This could be replaced with actual API calls in the future
  return [
