...
export const thoughtLeadershipData: ThoughtLeadershipItem[] = [
  ...
  {
    id: "ipsos-cannes-2026",
    type: "panel",
    title: "Moving Beyond the AI Hype",
    date: "2026-06-01",
    venue: "Ipsos",
    videoUrl: "https://www.youtube.com/watch?v=9dduozYCTSw",
    imageUrl: ipsosCannesImage.url,
    hideComingSoon: true,
    topics: ["AI"],
  },
  {
  ...
  },
  {
    ...
    imageUrl: linkedInForSalesImage.url,
    topics: ["AI", "GTM"],
  },
  {
  ...
  },
  {
    ...
    date: "2026-04-26",
    publication: "Adobe",
    quote: "AI is powering a once-in-a-generation transformation for how work gets done. It can handle the heavy lifting of data processing, pattern recognition, and repetitive tasks.",
