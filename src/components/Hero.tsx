...
export const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center relative bg-gradient-to-br from-primary/10 to-accent/10 px-4">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <div className="bg-secondary p-6 border-4 border-foreground transform rotate-1 hover:rotate-0 transition-transform duration-300 mb-8">
          <p className="text-xl md:text-2xl font-semibold text-secondary-foreground">
            5+ Years Experimenting with AI
          </p>
          <p className="text-lg md:text-xl text-muted-foreground mt-2">
            Technology • User Experience • Marketing Innovation
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button 
            size="lg" 
            className="text-lg font-bold px-8 py-4 transform hover:scale-105 transition-transform"
