  ...
  return (
    <section id="biography" className="mb-20">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-background border-8 border-foreground shadow-[12px_12px_0px_0px_hsl(var(--foreground))] p-8 md:p-12 transform hover:translate-x-[4px] hover:translate-y-[4px] hover:shadow-[8px_8px_0px_0px_hsl(var(--foreground))] transition-all duration-200">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-1">
              <div className="space-y-6">
                ...
                <p className="text-sm text-foreground/70 text-center font-bold">
